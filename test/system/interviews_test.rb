...
class InterviewsTest < ApplicationSystemTestCase
  ...
  test "should create interview" do
    ...
    fill_in "Contents", with: @interview.contents
    fill_in "Docter name", with: @interview.docter_name
    fill_in "Employee name", with: @interview.employee_name
    fill_in "Interveiw on", with: @interview.interveiw_on
