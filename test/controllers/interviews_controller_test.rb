...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference("Interview.count") do
      post interviews_url, params: { interview: { contents: @interview.contents, docter_name: @interview.docter_name, employee_name: @interview.employee_name, interveiw_on: @interview.interveiw_on } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { contents: @interview.contents, docter_name: @interview.docter_name, employee_name: @interview.employee_name, interveiw_on: @interview.interveiw_on } }
